...
W tym miejscu znajduje się pełna dokumentacja projektowa, techniczna oraz historyczny zapis prac nad systemem FocusFlow w ramach fazy MVP.

### 🗺️ Strategia i Specyfikacja
* [Specyfikacja Techniczna](docs/FocusFlow-Specyfikacja-Techniczna.md) – Architektura systemu, baza IndexedDB i logika reaktywna.
* [Roadmapa MVP](docs/FocusFlow-Roadmapa-MVP.md) – Kamienie milowe i plan rozwoju.
* [Specyfikacja PWA & Mobile](docs/PWA_Mobile_Spec.md) – Wytyczne dotyczące instalacji i optymalizacji mobilnej.
* [Plan Działania AI Team](docs/AI_TEAM-Plan_działania.md) – Protokół współpracy z agentami AI.

### 🏗️ Historia Budowy (Sprinty MVP)
Pełny zapis procesu deweloperskiego, audytów i decyzji projektowych:
* [Dokumentacja Zarządcza MVP](docs/MVP/dokumentacja_zarządcza-MVP.md)

#### 🌀 Szczegóły Etapów:
* **Sprint 01: Foundation**
  * [Backlog](docs/MVP/sprint%2001/Backlog%20Sprintu%2001.md) | [Briefing](docs/MVP/sprint%2001/Agent%20Briefing%2001.md) | [Raport QA](docs/MVP/sprint%2001/Raport%20QA.md)
* **Sprint 02: Brain Dump Pipeline**
  * [Backlog](docs/MVP/sprint%2002/Backlog%20sprintu%2002.md) | [Briefing](docs/MVP/sprint%2002/agent%20briefing%2002.md) | [Raport QA](docs/MVP/sprint%2002/raport%20QA%2002.md)
* **Sprint 03: Macierz & Context Menu**
  * [Backlog](docs/MVP/sprint%2003/backlog%20sprintu%2003.md) | [Briefing](docs/MVP/sprint%2003/agent%20briefing%2003.md) | [Raport QA](docs/MVP/sprint%2003/raport%20QA%2003.md)
* **Sprint 04: Focus Timer & Reaktywność**
  * [Backlog](docs/MVP/sprint%2004/backlog%20sprintu%2004.md) | [Briefing](docs/MVP/sprint%2004/agent%20briefing%2004.md) | [Raport QA](docs/MVP/sprint%2004/raport%20spirtu%2004.md)
* **Sprint 05: Visual Overhaul & PWA**
  * [Backlog](docs/MVP/sprint%2005/backlog%20sprintu%2005.md) | [Briefing](docs/MVP/sprint%2005/agent%20briefing%2005.md) | [Raport QA](docs/MVP/sprint%2005/raport%20sprintu%2005.md)

### 🎨 Interfejs Użytkownika (UI/UX)
Szczegółowe opisy logiczne poszczególnych ekranów:
* [Ekran 02: Macierz Eisenhowera](docs/dokumentacja%20techniczna%20ekranów%20UI/ekran%2002%20Macierz.md)
* [Ekran 03: Brain-dump](docs/dokumentacja%20techniczna%20ekranów%20UI/ekran%2003%20Brain-dump.md)
